...
impl std::fmt::Display for AgentInstanceStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            AgentInstanceStatus::AwaitingTool => write!(f, "WAITING_TOOL"),
            AgentInstanceStatus::AwaitingDelegation => write!(f, "WAITING_SUBAGENT"),
            AgentInstanceStatus::AwaitingApproval => write!(f, "WAITING_APPROVAL"),
...
impl TryFrom<&str> for AgentInstanceStatus {
    ...
    fn try_from(s: &str) -> Result<Self, Self::Error> {
        match s {
            ...
            "WAITING_TOOL" => Ok(AgentInstanceStatus::AwaitingTool),
            "WAITING_SUBAGENT" => Ok(AgentInstanceStatus::AwaitingDelegation),
            "WAITING_APPROVAL" => Ok(AgentInstanceStatus::AwaitingApproval),
