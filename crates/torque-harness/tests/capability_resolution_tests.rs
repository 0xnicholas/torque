...
use torque_harness::models::v1::capability::{
    CapabilityProfileCreate, CapabilityRegistryBindingCreate, QualityTier, RiskLevel,
};
...
async fn test_capability_resolve_by_ref() {
    ...
    let profile = service
        .create_profile(CapabilityProfileCreate {
    ...
    service
        .create_binding(CapabilityRegistryBindingCreate {
