...
pub async fn create_profile(
    ...
    let profile = services.capability.create_profile(req).await
        .map_err(|e| (
...
pub async fn list_profiles(
    ...
    let mut rows = services.capability.list_profiles(limit + 1).await
        .map_err(|e| (
            StatusCode::INTERNAL_SERVER_ERROR,
            Json(ErrorBody { code: "DB_ERROR".into(), message: e.to_string(), details: None, request_id: None })
        ))?;
...
pub async fn resolve(
    ...
    let result = services.capability.resolve(req).await
        .map_err(|e| (
            StatusCode::INTERNAL_SERVER_ERROR,
            Json(ErrorBody { code: "RESOLVE_ERROR".into(), message: e.to_string(), details: None, request_id: None })
        ))?;
    Ok(Json(result))
}
...
pub async fn create_binding(
    ...
    let binding = services.capability.create_binding(req).await
        .map_err(|e| (
            StatusCode::INTERNAL_SERVER_ERROR,
            Json(ErrorBody { code: "DB_ERROR".into(), message: e.to_string(), details: None, request_id: None })
        ))?;
...
pub async fn list_bindings(
    ...
    let limit = q.limit.clamp(1, 100);
    let mut rows = services.capability.list_bindings(limit + 1).await
        .map_err(|e| (
            StatusCode::INTERNAL_SERVER_ERROR,
            Json(ErrorBody { code: "DB_ERROR".into(), message: e.to_string(), details: None, request_id: None })
        ))?;
